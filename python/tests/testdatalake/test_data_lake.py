...
def test_crear_contenedor_data_lake(datalake):
	...
	nombre_contenedores=[contenedor["name"] for contenedor in contenedores]

	assert "contenedor1" in nombre_contenedores
