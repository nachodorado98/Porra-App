...
def test_pagina_porra_porra_cerrada_porra_no_realizada(cliente, conexion_usuario, dias):
	...
	assert '<p class="descripcion-pregunta">¡El evento ya ha empezado! Puedes seguir tus resultados en directo.</p>' not in contenido
	assert '<p class="descripcion-pregunta">¡Mucha suerte!' not in contenido
	assert '<p class="descripcion-pregunta">El evento ya ha empezado pero no puedes seguir tus resultados en directo ya que no has completado la porra. Lo sentimos</p>' not in contenido
	assert '<li><a href="/puntuacion/detalle/nacho98">Mis Resultados</a></li>' not in contenido
...
def test_pagina_porra_no_puede_ver_resultados_porra_no_realizada(cliente, conexion_usuario, dias):
	...
	assert '<p class="descripcion-pregunta">¡El evento ya ha empezado! Puedes seguir tus resultados en directo.</p>' not in contenido
	assert '<p class="descripcion-pregunta">¡Mucha suerte!' not in contenido
	assert '<p class="descripcion-pregunta">El evento ya ha empezado pero no puedes seguir tus resultados en directo ya que no has completado la porra. Lo sentimos</p>' in contenido
	assert '<li><a href="/puntuacion/detalle/nacho98">Mis Resultados</a></li>' not in contenido

@pytest.mark.parametrize(["dias"],
	[(2,),(22,),(5,),(13,),(25,),(1,),(0,)]
)
def test_pagina_porra_puede_ver_resultados_porra_realizada(cliente, conexion_usuario, dias):
	...
	assert '<a href="/porra/reiniciar" class="btn-reiniciar" data-loading="true">Rehacer porra desde el inicio ⟳</a>' not in contenido
	assert '<li><a href="/porra/mi_porra">Mi Porra</a></li>' in contenido
	assert '<p class="descripcion-pregunta">¡El evento ya ha empezado! Puedes seguir tus resultados en directo.</p>' in contenido
	assert '<p class="descripcion-pregunta">¡Mucha suerte!' in contenido
	assert '<p class="descripcion-pregunta">El evento ya ha empezado pero no puedes seguir tus resultados en directo ya que no has completado la porra. Lo sentimos</p>' not in contenido
	assert '<li><a href="/puntuacion/detalle/nacho98">Mis Resultados</a></li>' in contenido