...
def test_pagina_clasificacion_liga_sin_login(cliente, conexion):

	respuesta=cliente.get("/clasificacion/liga/123456", follow_redirects=True)
...
def test_pagina_clasificacion_liga_no_existe_codigo(cliente, conexion_usuario):

	with cliente as cliente_abierto:

		cliente_abierto.post("/login", data={"usuario": "nacho98", "contrasena": "Ab!CdEfGhIJK3LMN"}, follow_redirects=True)

		respuesta=cliente_abierto.get("/clasificacion/liga/123456")
...
def test_pagina_clasificacion_liga_no_codigo_usuario(cliente, conexion_usuario):
...
def test_pagina_clasificacion_liga(cliente, conexion_usuario):
	...
	with cliente as cliente_abierto:
		...
		respuesta=cliente_abierto.get("/clasificacion/liga/3YYZKP")
...
def test_pagina_clasificacion_liga_con_imagen(cliente, conexion_usuario):
...
def test_pagina_clasificacion_liga_puede_pinchar_no_admin(cliente, conexion_usuario):
...
def test_pagina_clasificacion_liga_puede_pinchar_porra_abierta(cliente, conexion_usuario, dias):
...
def test_pagina_clasificacion_liga_puede_pinchar_admin(cliente, conexion_usuario):
...
def test_pagina_clasificacion_liga_puede_pinchar_porra_cerrada(cliente, conexion_usuario, dias):
...
def test_pagina_clasificacion_liga_puede_pinchar_admin_porra_no_completada(cliente, conexion_usuario):
...
def test_pagina_clasificacion_liga_puede_pinchar_porra_cerrada_porra_no_completada(cliente, conexion_usuario, dias):
