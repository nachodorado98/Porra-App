...
from config import EMAIL_ACCOUNT, CONTRASENA_LOGIN, SERVIDOR_CORREO, PUERTO_CORREO, ASUNTO_CORREO, HTML_CORREO
...
def enviarCorreoBienvenida(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        enviarCorreo(correo_destino, ASUNTO_CORREO, HTML_CORREO.format(nombre=nombre_usuario, codigo=codigo), EMAIL_ACCOUNT, CONTRASENA_LOGIN, SERVIDOR_CORREO, PUERTO_CORREO)
